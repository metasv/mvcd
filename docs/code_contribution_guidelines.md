...
reason, the metasv suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire metasv
...
commits](https://github.com/metasv/bsvd/commits/master) for examples of
commit messages.
...
Rejoice as you will now be listed as a [contributor](https://github.com/metasv/bsvd/graphs/contributors)!
...
[ISC license](https://github.com/metasv/bsvd/blob/master/LICENSE).  This is
the same license as all of the code in the metasv suite.

...
reason, the yaochaoutokyo suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire yaochaoutokyo
...
One of the major design goals of all core bsvd packages is to aim for complete
...
commits](https://github.com/yaochaoutokyo/bsvd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into bsvd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/yaochaoutokyo/bsvd/graphs/contributors)!
...
[ISC license](https://github.com/yaochaoutokyo/bsvd/blob/master/LICENSE).  This is
the same license as all of the code in the yaochaoutokyo suite.

...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/metasv/mvcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/metasv/mvcd/blockchain/fullblocktests
```

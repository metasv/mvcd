...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []mvcutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []mvcutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee mvcutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee mvcutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address mvcutil.Address, amount mvcutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address mvcutil.Address, amount mvcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address mvcutil.Address,
	amount mvcutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address mvcutil.Address, amount mvcutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentSubFeeAsync(address mvcutil.Address, amount mvcutil.Amount, comment, commentTo string, subtractFeeFromAmount bool) FutureSendToAddressResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressCommentSubFee(address mvcutil.Address, amount mvcutil.Amount, comment, commentTo string, subtractFeeFromAmount bool) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress mvcutil.Address, amount mvcutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress mvcutil.Address, amount mvcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress mvcutil.Address, amount mvcutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress mvcutil.Address, amount mvcutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress mvcutil.Address, amount mvcutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress mvcutil.Address,
	amount mvcutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[mvcutil.Address]mvcutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[mvcutil.Address]mvcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[mvcutil.Address]mvcutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[mvcutil.Address]mvcutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (mvcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return mvcutil.DecodeAddress(addmultisigRes.Address, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []mvcutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []mvcutil.Address, account string) (mvcutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []mvcutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []mvcutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (mvcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return mvcutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) GetNewAddress(account string) (mvcutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (mvcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (mvcutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (mvcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (mvcutil.Address, error) {
...
func (c *Client) GetAccountAsync(address mvcutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address mvcutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address mvcutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address mvcutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]mvcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]mvcutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := mvcutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]mvcutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount mvcutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount mvcutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount mvcutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount mvcutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount mvcutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount mvcutil.Amount,
...
func (c *Client) ValidateAddressAsync(address mvcutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address mvcutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]mvcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]mvcutil.Amount)
	for k, v := range accounts {
		amount, err := mvcutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]mvcutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]mvcutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (mvcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := mvcutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (mvcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (mvcutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (mvcutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (mvcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (mvcutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (mvcutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (mvcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (mvcutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (mvcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address mvcutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address mvcutil.Address) (mvcutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address mvcutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address mvcutil.Address, minConfirms int) (mvcutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address mvcutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address mvcutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address mvcutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address mvcutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*mvcutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return mvcutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address mvcutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address mvcutil.Address) (*mvcutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *mvcutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *mvcutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *mvcutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *mvcutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *mvcutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *mvcutil.WIF, label string, rescan bool) error {
